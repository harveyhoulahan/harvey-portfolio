    ...
    <div className="mt-6 border-t border-contour">
      {caseStudies.map((study, i) => (
        <Link
          ...
          className="group relative grid grid-cols-[2.5rem_1fr_auto] items-baseline gap-x-4 border-b border-contour py-5 pr-2 transition-colors duration-300 hover:bg-terrace/60 md:grid-cols-[3rem_1.1fr_1fr_auto]"
        >
          <span
            aria-hidden
          ...
          />
          <span className="pl-4 font-mono text-xs tabular-nums text-ink/40">
