  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="col-shell relative z-10 max-w-work pb-14 pt-16 md:pb-16 md:pt-24">
        <div className="md:max-w-[min(42rem,calc(100%-min(40vw,440px)-2rem))]">
      ...
      {/* Desktop — anchored from the right, vertically centred in the hero */}
      <div className="pointer-events-none absolute inset-y-0 right-[clamp(2.5rem,8vw,6rem)] z-10 hidden w-[min(38vw,400px)] flex-col justify-center md:flex">
